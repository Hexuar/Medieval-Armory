...
execute as @a[scores={medieval_armory.ender_pearl_cooldown=..0},nbt={SelectedItem:{tag:{medieval_armory:{polearm:1b,thrust:1b}}}}] run function medieval_armory:item/polearm/reset